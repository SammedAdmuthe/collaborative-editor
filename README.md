...
</br>2. Run the testScript.py - python3 testScript.py.</br>3. The script uses logs generated (output3000.txt) from the application to give fair estimate of different metrics.
